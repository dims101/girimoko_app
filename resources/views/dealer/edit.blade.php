        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <select name="dds" id="dds"  class="form-control @error('dds') is-invalid @enderror" required>
                    ...
                    @foreach($dds as $d)
                    <option value="{{$d->dds}}" <?=$dealer->dds == $d->dds ? 'selected':''?>>{{$d->dds}}</option>
                    @endforeach
                </select>
                @error('dds')
                    <span class="invalid-feedback" role="alert">
            ...
            <div class="col-md-6">
                <select name="depo" id="depo"  class="form-control @error('depo') is-invalid @enderror" required>
                    <option value="">--Pilih--</option>
                    @foreach($depo as $d)
                    <option value="{{$d->depo}}" <?=$dealer->depo == $d->depo ? 'selected':''?>>{{$d->depo}}</option>
                    @endforeach
                </select>
                @error('depo')
                    <span class="invalid-feedback" role="alert">
            ...
            <div class="col-md-6">
                <select name="rayon" id="rayon"  class="form-control @error('rayon') is-invalid @enderror" required>
                    <option value="">--Pilih--</option>
                    @foreach($rayon as $d)
                    <option value="{{$d->rayon}}" <?=$dealer->rayon == $d->rayon ? 'selected':''?>>{{$d->rayon}}</option>
                    @endforeach
                </select>
                @error('rayon')
                    <span class="invalid-feedback" role="alert">
