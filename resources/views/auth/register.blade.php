                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                <div class="btn-group">
                                   <form action="user/{{  $user->id }}/edit" method="get"> <button class="badge badge-sm badge-round badge-info"><i class="material-icons">drive_file_rename_outline</i></button></form>
